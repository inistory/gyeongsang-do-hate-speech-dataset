...
for pair in data:
    ...
    if is_profanity(standard):
        hs_pairs.append(pair)

# 결과를 hs_pair.json 파일로 저장
with open('hs_pair.json', 'w', encoding='utf-8') as f:
    json.dump(hs_pairs, f, ensure_ascii=False, indent=4)

print(f"욕설에 해당하는 {len(hs_pairs)}개의 쌍이 hs_pair.json에 저장되었습니다.")